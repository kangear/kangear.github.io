...
<div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
  <div style="width: 32%; text-align: center;">
    <div style="width: 100%; position: relative;">
      <img src="/assets/c78741c639b933b344e69174f680e805.jpg" alt="发现设备" style="width: 100%; display: block;" />
    </div>
    <div style="width: 100%; text-align: center; margin-top: 8px;">1</div>
  </div>
  <div style="width: 32%; text-align: center;">
    <div style="width: 100%; position: relative;">
      <img src="/assets/f3e66e60897d2c31e0213463269be8d0.jpg" alt="填写WiFi账号和密码" style="width: 100%; display: block;" />
    </div>
