---
layout: post
title:  "yourapiexpert/ATCommands无法使用？"
...
使用Arduino驱动4G模块，需要使用AT指令相关的库，网上搜到了[yourapiexpert/ATCommands][1]，看介绍功能都能满足，但是基本的例子却跑不起来，这里记录一下。
...
| ![有帮助的截图](/assets/微信截图_20240224170736.png) |
| :----------------------------------------: |
|          *例子*          |

[1]: https://github.com/yourapiexpert/ATCommands