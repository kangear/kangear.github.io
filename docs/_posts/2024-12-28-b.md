...
| :------------: | :------------: | :------------: | :------------: |
|  列表会多出一个WiFi热点`HomeSpan-Setup`  |  输入密码`homespan`连接    |  按`下箭头`打开WiFi弹窗*    |     *为设备选择家里的WiFi，这里以`QWRT-2.4G`为例*          |

| ![有帮助的截图](/assets/ed43cb786850765932d7bcb6ce1cfd2.jpg) | ![有帮助的截图](/assets/bbced2c17aa0b7547830f9da607f794.jpg) | ![有帮助的截图](/assets/4d8a5222ecda1cb52b8bb51f61bffaa.jpg) |![有帮助的截图](/assets/2e7b26586724e64d2bac8042152e081.jpg) |
| :------------: | :------------: | :------------: | :------------: |
|  *填入家里WiFi的密码，并提交(SUBMIT)*   |  *等待设备连网...(大约30秒)*    |    *保持为空，直接保存(SAVE Settings)*    |      *提示完成*   | 
